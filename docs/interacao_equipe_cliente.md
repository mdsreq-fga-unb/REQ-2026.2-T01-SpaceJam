...
O professor George Marsicano orienta e avalia o trabalho conforme o calendário da disciplina e registra feedbacks nas entregas e no repositório. O monitor Heitor acompanha o andamento da equipe e pode ser consultado para esclarecer dúvidas sobre o processo e os artefatos. Durante a reunião semanal, a equipe verificará os feedbacks pendentes e decidirá quais questões precisam ser encaminhadas ao professor ou ao monitor.

## 7.4 Processo de Validação

A validação será contínua e acompanhará a evolução dos itens de trabalho. O processo adotado é:

1. **Preparação:** selecionar o requisito, fluxo, protótipo ou incremento e identificar o usuário afetado e os critérios que precisam ser avaliados;
...
- usuário afetado;
- requisito ou artefato avaliado;
